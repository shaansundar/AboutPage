  ...
  return (
    ...
    to-green-light ">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:max-w-heroimgwidth lg:w-heroimgwidth md:w-1/2 w-5/6 mb-10 md:mb-0 mb scale-125 transform hover:scale-125 mr-10 duration-300 ease-in-out">
